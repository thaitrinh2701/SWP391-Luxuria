        ...
        >
          <ul className="space-y-1.5">
            <li>
              <NavLink
                className={({ isActive }) =>
                  `flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-900 rounded-lg hover:bg-gray-100 dark:hover:bg-[#374151] dark:text-neutral-400 dark:hover:text-neutral-300 ${
                    isActive
